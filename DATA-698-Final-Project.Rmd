...
For purpose of this project, our target variable will be derived from `NAMED.INSURED`, which is the beneficiary listed for each workers comp policy.  The named insured will be the PEO in the case of a PEO arrangement.  
...
Further analysis can be performed to gain competitive business advantage. The two areas I see
...
Internal Evaluation Criteria for Cate- gorical Data in Hierarchical Clustering: Optimal Number of Clusters Determination, Metodoloski Zveski, 15(2), p. 1-20.
